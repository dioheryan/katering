        ...
        <div class="row align-items-center">
            ...
            <div class="col-xl-6 offset-xl-1 col-lg-6 offset-lg-1">
                <div class="single_about_thumb thumb_n1">
                    <img src="<?= base_url('assets/'); ?>img/about/1.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6">
                <div class="single_about_thumb thumb_n2">
                    <img src="<?= base_url('assets/'); ?>img/about/2.png" alt="">
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="testmonial_active owl-carousel">
                    ...
                    <div class="single_testmonial d-flex">
                        <div class="testmonial_thumb">
                            <img src="<?= base_url('assets/'); ?>img/testmonial/2.png" alt="">
                        </div>
                        <div class="testmonial_author">
                            <h3>Adam Nahan</h3>
                            <span>Chief Customer</span>
        ...
        <div class="row">
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/1.png" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/02.png" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/03.png" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/04.png" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/05.png" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/06.png" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/7.png" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/12.png" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/9.png" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/10.png" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/11.png" alt="">
                </div>
            </div>
            <div class="col-xl-2 col-md-6 col-lg-3">
                <div class="single_brand">
                    <img src="<?= base_url('assets/'); ?>img/brand/8.png" alt="">
                </div>
            </div>
        </div>
    </div>
